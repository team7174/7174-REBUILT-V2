...
class TunerConstants {
  ...
  static constexpr std::string_view kCANBusName = "Chassis";
 ...
 public:
  ...
  // This needs to be tuned to your individual robot
  static constexpr units::meters_per_second_t kSpeedAt12Volts = 6.53_mps;
 ...
 private:
  ...
  static constexpr int kPigeonId = 6;
 ...
 private:
  ...
  static constexpr int kFrontLeftSteerMotorId = 41;
  static constexpr int kFrontLeftEncoderId = 42;
  static constexpr units::turn_t kFrontLeftEncoderOffset = -0.1328125_tr;
  static constexpr bool kFrontLeftSteerMotorInverted = true;
  static constexpr bool kFrontLeftEncoderInverted = false;

  static constexpr units::inch_t kFrontLeftXPos = 11_in;
  static constexpr units::inch_t kFrontLeftYPos = 11_in;

  // Front Right
  static constexpr int kFrontRightDriveMotorId = 10;
  static constexpr int kFrontRightSteerMotorId = 11;
  static constexpr int kFrontRightEncoderId = 12;
  static constexpr units::turn_t kFrontRightEncoderOffset = 0.038330078125_tr;
  static constexpr bool kFrontRightSteerMotorInverted = true;
  static constexpr bool kFrontRightEncoderInverted = false;

  static constexpr units::inch_t kFrontRightXPos = 11_in;
  static constexpr units::inch_t kFrontRightYPos = -11_in;

  // Back Left
  static constexpr int kBackLeftDriveMotorId = 30;
  static constexpr int kBackLeftSteerMotorId = 31;
  static constexpr int kBackLeftEncoderId = 32;
  static constexpr units::turn_t kBackLeftEncoderOffset = 0.22119140625_tr;
  static constexpr bool kBackLeftSteerMotorInverted = true;
  static constexpr bool kBackLeftEncoderInverted = false;

  static constexpr units::inch_t kBackLeftXPos = -11_in;
  static constexpr units::inch_t kBackLeftYPos = 11_in;

  // Back Right
  static constexpr int kBackRightDriveMotorId = 20;
  static constexpr int kBackRightSteerMotorId = 21;
  static constexpr int kBackRightEncoderId = 22;
  static constexpr units::turn_t kBackRightEncoderOffset = 0.20361328125_tr;
  static constexpr bool kBackRightSteerMotorInverted = true;
  static constexpr bool kBackRightEncoderInverted = false;

  static constexpr units::inch_t kBackRightXPos = -11_in;
  static constexpr units::inch_t kBackRightYPos = -11_in;
